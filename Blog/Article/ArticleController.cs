...
namespace Blog.Article
{
  public class ArticleController
  {
    ...
    [UrlPattern("{Uri}")]
    public ArticlePageViewModel Index(ArticleInputModel inputModel)
    {
